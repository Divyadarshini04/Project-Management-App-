				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
							<span class="badge badge-<?php echo $row['pstatus'] == 3 ? 'success' : ($row['pstatus'] == 2 ? 'primary' : ($row['pstatus'] == 1 ? 'secondary' : 'danger')) ?>"><?php echo $stat[$row['pstatus']] ?></span>
						</td>
						<td>
                        	<span class="badge badge-<?php echo $row['status'] == 3 ? 'success' : ($row['status'] == 2 ? 'primary' : 'secondary') ?>"><?php echo $row['status'] == 3 ? 'Done' : ($row['status'] == 2 ? 'On-Progress' : 'Pending') ?></span>
                        </td>
						<td class="text-center">
							<div class="btn-group">
